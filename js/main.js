...
var votingApp = {
	...
	toHTML : function() {
            ...
            infopara.setAttribute("id", "infograph", "class", 'infoP');
            ...
            var titleResults = document.createElement("h2");
            var innerTitleResults = document.createTextNode("Results");
            titleResults.appendChild(innerTitleResults);
            
            var resultContainer = document.getElementsByClassName("info")[0]
            resultContainer.appendChild(titleResults);
